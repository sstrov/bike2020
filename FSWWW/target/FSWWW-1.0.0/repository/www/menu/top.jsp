...
<nav>
			<ul class="gnb-list">
				...
				<li class="gnb-item">
					<a href="<c:url value='/sub.do?key=1910168794317' />" target="_self" class="btn btn-gnb-item">시각화서비스</a>
					...
					<ul class="depth-list">
						...
						<li class="depth-item">
							<a href="<c:url value='/stats/examin/form.do?key=1911210359546&ty=3' />" target="_self">조사자료 통계</a>
						</li>
				...
				<li class="gnb-item">
					<a href="<c:url value='/sub.do?key=1910168794919' />" target="_self" class="btn btn-gnb-item">통계 간행물</a>
					...
					<ul class="depth-list">
						...
						<li class="depth-item">
							<a href="<c:url value='/bbs/list.do?key=1911210368985' />" target="_self">여성통계</a>
						</li>
				...
				<li class="gnb-item">
					<a href="<c:url value='/sub.do?key=1911210369753' />" target="_self" class="btn btn-gnb-item">한눈에보는 세종</a>
				...
				<li class="gnb-item">
					<a href="<c:url value='/sub.do?key=1911210372234' />" target="_self" class="btn btn-gnb-item">Open API</a>
				...
				<li class="gnb-item">
					<a href="<c:url value='/sub.do?key=1911210374043' />" target="_self" class="btn btn-gnb-item">통계소식</a>
