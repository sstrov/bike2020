...
public class ConectrStatsVO implements Serializable {

	private static final long serialVersionUID = 1L;
	
	private Integer conectrStatsSn;		// 접속자_통계_일련번호
	...
	public Integer getConectrStatsSn() {
		return conectrStatsSn;
	}
	public void setConectrStatsSn(Integer conectrStatsSn) {
		this.conectrStatsSn = conectrStatsSn;
	}
