...
function changeSearch() {
	...
	f.action = '/${ admURI }/stat/day.do?key=${ param.key }';
	f.submit();
}
</script>
<style type="text/css">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-9">
							...
							<div class="btn-group">
								<button type="button" class="btn btn-info" onclick="$('#sc_year').val('${ tYear }'); $('#sc_month').val('${ tMonth }');"><i class="fa fa-refresh"></i> 초기화</button>
							</div>
						</div>
					</div>
