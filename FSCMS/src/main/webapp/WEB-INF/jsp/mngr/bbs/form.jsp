									...
									<c:choose>
										<c:when test="${ list.bbsFieldCode eq 'ctgryNm' }">
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6">
													<select id="bbsCtgrySn" name="bbsCtgrySn" onchange="subCtgry(this.value);" class="form-control" <c:if test="${ list.fieldEssntlAt eq 'Y' }">data-parsley-required="true"</c:if>>
													...
													<label class="select" style="float:left; margin:0;">
														<form:select path="bbsCtgrySubSn" cssClass="form-control">
