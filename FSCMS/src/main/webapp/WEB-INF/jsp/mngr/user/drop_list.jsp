...
<form:form id="frm" name="frm" method="post" commandName="searchVO" cssClass="form-horizontal">
	...
	<input type="hidden" name="userSttus" />
				...
				<div class="panel-body">
						...
						<div class="col-md-9">
							<label class="select" style="float:left; margin:0;">
								<form:select path="sc" cssClass="form-control">
									...
									<%-- <form:option value="USER_NM">관리자 명</form:option> --%>
								</form:select>
							</label>
					...
					<div class="form-group">
						<div class="col-md-10" style="text-align:center;">
							<button type="button" class="btn btn-sm btn-primary m-r-5" onclick="changeSearch('year');"><i class="fa fa-search"></i> 2년 재동의 미동의</button>
							<button type="button" class="btn btn-sm btn-primary m-r-5" onclick="changeSearch('self');"><i class="fa fa-search"></i> 수동 탈퇴</button>
						...
						<table id="data-table" class="table table-striped table-bordered">
							...
							<tfoot class="hide">
								<tr>
									...
									<td><span onclick="goModify('{key}');" style="cursor:pointer;">{userId}</span></td>
									<td><span onclick="goModify('{key}');" style="cursor:pointer;">{userNm}</span></td>
									<td><span onclick="goModify('{key}');" style="cursor:pointer;">{tel}</span></td>
									<td><span onclick="goModify('{key}');" style="cursor:pointer;">{email}</span></td>
									<td><span onclick="goModify('{key}');" style="cursor:pointer;">{noteSn}</span></td>
