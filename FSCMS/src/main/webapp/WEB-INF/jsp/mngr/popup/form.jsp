		...
		<form:form id="frm" name="frm" method="post" commandName="searchVO" cssClass="form-horizontal form-bordered" data-parsley-validate="true">
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body panel-form">
					...
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4">링크 * :</label>
						<div class="col-md-6 col-sm-6">
							<input type="text" id="popupLink" name="popupLink" class="form-control" <c:if test="${ empty role || role.powW ne 'Y' }">disabled</c:if> data-parsley-required="true" placeholder="링크 입력" value="${ item.popupLink }" />
						</div>
					</div>
