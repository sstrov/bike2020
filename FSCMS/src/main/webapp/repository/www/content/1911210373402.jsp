...
<link rel="stylesheet" href="/resource/static/css/E-openAPI/E1.css">
<link rel="stylesheet" href="/resource/static/css/E-openAPI/E2.css">
...
<div class="box-e type2">
	...
	<div class="text-e api-box">
		<div class="data-tab-content api">
			<!-- FIXME: 디자인 미확정 -->
			<div class="bg-box">
				<p>요청주소: https://www.sejong.go.kr/openapi/getList.do
				</p>
				<p>요청제한횟수: 제한없음</p>
			</div>
			<div class="table-box">
				<div class="title-b">기본인자
					<div class="api-btn">
						<button type="button" class="key-request-btn" onclick="window.open('http://data.go.kr');">인증키 신청
							<img src="/resource/static/image/common/api-icon-02.png" alt="인증키신처 아이콘">
						</button>
						<!-- <button>명세서 다운로드<img src="/resource/static/image/common/api-icon-03.png" alt="다운로드 아이콘"></button> -->
					</div>
				</div>
				<table class="table table-bordered">
					<caption>기본인자 목록 - 변수명, 타입, 변수설명, 설명 제공</caption>
					<colgroup>
						<col style="width:20%" />
						<col style="width:20%" />
						<col style="width:20%" />
			...
			<div class="api-tab-container">
				<div class="api-tab-name-box">
					...
					<a href="#this" class="dummy"></a>
				</div>
				<div class="api-tab-content">
					<!-- 출력값 시작 -->
					<div class="table-box">
						<table class="table table-bordered">
							<caption>출력값 목록 - 번호, 출력명, 출력설명 제공</caption>
							<colgroup>
								<col style="width:20%" />
								<col style="width:20%" />
								<col style="width:60%" />
				...
				<script>
					...
					function apiSearch() {
						$.ajax({
							url     : "/openapi/getList.do?key=${ param.key }",
							type    : "POST",
							data    : {
				...
				<div class="api-tab-content">
					...
					<div class="api-input">
						<p>tblId(필수)</p>
						<input type="text" name="apiTblId" value="DT_20802N_006">
					...
					<div class="table-box">
						<table class="table table-bordered table-a">
							...
							<tbody>
								<tr>
									<td>요청주소</td>
									<td>https://www.sejong.go.kr/openapi/getList.do</td>
								</tr>
								<tr>
									<td>API 결과</td>
									<td>
				...
				<div class="api-tab-content">
					...
					<div class="table-box">
						<table class="table table-bordered table-a">
							<caption>메시지설명 목록 - 구분, 코드, 설명 제공</caption>
							<colgroup>
								<col style="width:20%" />
								<col style="width:20%" />
								<col style="width:60%" />
...
<div class="box-e type2">
	...
	<div class="text-e">
		...
		<div class="background-box">
			http://<span class="api-url">www.sejong.go.kr/openapi</span>
			<span class="api-name">/...../getList.do?apiKey=</span>
			<span class="api-value">[ 인증키 ]</span>&tblId=DT_20802N_006&maxSize=100
		</div>
		<ol>
			<li>
...
<script src="/resource/static/js/A-stateData/api-tab.js"></script>