...
public class UserSearchVO extends UserVO {
	...
	private String sc_expire;
	private String sc_push;
	...
	public String getSc_expire() {
		return sc_expire;
	}
	public void setSc_expire(String sc_expire) {
		this.sc_expire = sc_expire;
	}
	public String getSc_push() {
		return sc_push;
	}
	public void setSc_push(String sc_push) {
		this.sc_push = sc_push;
	}
