...
public class ErrorHistServiceImpl extends EgovAbstractServiceImpl implements ErrorHistService {
	...
	@Override
	public int selectTCount(ErrorHistSearchVO searchVO) throws Exception {
		return errorHistDAO.selectTCount(searchVO);
	}

	@Override
	public List<ErrorHistVO> selectPageList(ErrorHistSearchVO searchVO) throws Exception {
		return errorHistDAO.selectPageList(searchVO);
	}
