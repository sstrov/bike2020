...
public class AuthUploadSearchVO extends AuthUploadVO{
...
private static final long serialVersionUID = 1L;
	...
	private String  sc_privateAt;
	
	private String  sc_sub;
	...
	public String getSc_privateAt() {
		return sc_privateAt;
	}
	public void setSc_privateAt(String sc_privateAt) {
		this.sc_privateAt = sc_privateAt;
	}
	public List<Field> getFieldList() {
		List<Field> fieldList = ExcelUtil.annotaionFieldList(this.getClass(), TableList.class, true);
		return fieldList;
	}
	public String getSc_sub() {
		return sc_sub;
	}
	public void setSc_sub(String sc_sub) {
		this.sc_sub = sc_sub;
	}
}
